...
const IsKazasiScreen = ({ navigation }) => {
  ...
  const handleCalculate = async () => {
    ...
    try {
      ...
      const response = await calculationService.calculateIsKazasi(requestData);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>İş Kazası Tazminat Hesaplama</Text>
        <View style={{ width: 24 }} />
      </View>
